...
MODEL     = PID_control
TARGET      = sfun
MODULE_SRCS   = c2_PID_control.c
MODEL_SRC  = PID_control_sfun.c
MODEL_REG = PID_control_sfun_registry.c
MAKEFILE    = PID_control_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Carter\Desktop\subbots\Simulations\slprj\_sfprj\PID_control\_self\sfun\src" 
...
OBJLIST_FILE = PID_control_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
